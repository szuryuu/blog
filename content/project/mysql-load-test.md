...
image: "/images/project/mysql.png"
...
- **Zero Overhead:** Enabling the "General Query Log" in MySQL kills performance. By capturing traffic at the network layer (TCP/IP) using `gopacket`, I could extract SQL queries from a production server without adding _any_ load to the database itself.
